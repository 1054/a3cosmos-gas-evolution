...
def calc_alphaCO_from_metalZ_following_Wilson1995(metalZ):
    """Calculating α_CO from metallicity following Wilson et al. (1995ApJ...448L..97W) Eq. (4).
    """
...
def calc_alphaCO_from_metalZ_following_Magdis2012(metalZ):
    """Calculating α_CO from metallicity following Magdis et al. (2012ApJ...760....6M) Eq. (8).
    """
    return np.power(10.0, (12.8) - (1.39) * metalZ )


def calc_alphaCO_from_metalZ_following_Genzel2012(metalZ):
    """Calculating α_CO from metallicity following Genzel et al. (2012ApJ...746...69G) Eq. (7) or Fig. 5 label.
    """
...
def calc_alphaCO_from_metalZ_following_Genzel2015a(metalZ, metalZ_solar = 8.67, alphaCO_MilkyWay = 4.36):
    """Calculating α_CO from metallicity following Genzel et al. (2015ApJ...800...20G) Eq. (6).
    """
    # 
...
def calc_alphaCO_from_metalZ_following_Genzel2015b(metalZ, metalZ_solar = 8.67, alphaCO_MilkyWay = 4.36):
    """Calculating α_CO from metallicity following Genzel et al. (2015ApJ...800...20G) Eq. (7).
    """
    # 
    # alphaCO_MilkyWay 4.36 ± 0.9 (M⊙ (K km s−1 pc2 )−1 ), 
    #   which is equivalent to XCO = N(H2)/(TRJ=1∆v) = 2 × 10^20 (cm−2 (K km s−1)−1; 
...
def calc_alphaCO_from_metalZ_following_Bolatto2013(metalZ, Sigma_total, Sigma_GMC_100 = 1.0, metalZ_solar = 8.67, alphaCO_MilkyWay = 4.36):
    """Calculating α_CO from metallicity following Bolatto et al. (2013ARA&A..51..207B) Eq. (31) on PDF page 55.
    """
    # 
...
def calc_alphaCO_from_metalZ_following_Accurso2017(metalZ, DeltaMS = 0.0):
    """Calculating α_CO from metallicity following Accurso et al. (2017ApJ...845L..97W) Eq. (24).
    """
    return np.power(10.0, 14.752 - 1.623 * metalZ + 0.062 * DeltaMS)


def calc_alphaCO_from_metalZ_following_Bertemes2018(metalZ):
    """Calculating α_CO from metallicity following Bertemes et al. (2018MNRAS.478.1442B) using the geometric mean of Genzel2012 and Bolatto2013 alphaCO.
    """
...
def calc_alphaCO_from_metalZ_following_Tacconi2018(metalZ):
    """Calculating α_CO from metallicity following Tacconi et al. (2018ApJ...853..179T, see their Eq.(2)) using the geometric mean of Genzel2012 and Bolatto2013 alphaCO.
    (see also Equations (6) and (7) in Genzel2015)
...
def calc_alphaCO_from_metalZ_following_Boselli2014(lgL_Hband):
    """Calculating α_CO from metallicity following Boselli et al. (2014A&A...564A..65B) using a luminosity dependent alphaCO.
    """
